...
[program]: https://package.elm-lang.org/packages/elm/html/latest/Html#program
[programWithFlags]: https://package.elm-lang.org/packages/elm/html/latest/Html#programWithFlags
...
The particular types that can be sent in and out of ports are quite flexible, covering [all valid JSON values](http://www.json.org/). Specifically, incoming ports can handle all the following Elm types:
  ...
  * **Json**    &ndash; [`Json.Encode.Value`](https://package.elm-lang.org/packages/elm/core/latest/Json-Encode#Value) corresponds to arbitrary JSON
