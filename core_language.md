...
This works best when you follow along. So first [get everything installed](http://elm-lang.org/install) and then [familiarize yourself with the command line tools](http://elm-lang.org/get-started). Once that is all set, start up `elm-repl` in the terminal. Assuming you have Node.js installed, you should see something like this:
