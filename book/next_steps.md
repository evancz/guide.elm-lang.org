...
- **Expand Examples** &mdash; Take some of the examples from this book and add to them. Try the exercises on [here](https://elm-lang.org/examples) and [here](https://github.com/evancz/elm-architecture-tutorial/). Mess with [`elm-spa-example`](https://github.com/rtfeldman/elm-spa-example).
